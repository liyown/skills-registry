...
## Planned (v0.6.1+, RFC in `docs/rfcs/2026-06-10-enterprise-flow-skills.md`)

These 8 skills are not yet shipped. The install line is the planned shape; do not run it until the skill lands.

| Planned skill | One-line summary | Planned install |
| --- | --- | --- |
...
# superpower-enterprise — install one or more of the 8 shipped skills
...
For the 8 planned skills above, the rename means their first published install line will already be on the new path. No migration needed for the planned skills.
